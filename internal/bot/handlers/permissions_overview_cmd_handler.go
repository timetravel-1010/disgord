...
var (
	dmPermission                   = false
	defaultMemberPermissions int64 = 2048
	PermissionOverviewCmd          = &discordgo.ApplicationCommand{
...
func PermissionsOverviewCmdHandler(s *discordgo.Session, i *discordgo.InteractionCreate) {
